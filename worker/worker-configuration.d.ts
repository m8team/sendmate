/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.jsonc --strict-vars=false ./worker-configuration.d.ts` (hash: ce9ac3003ef6933d260f28c164c67ad1)
// Runtime types generated with workerd@1.20260911.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	RL_SUBMIT_IP: RateLimit;
	RL_SUBMIT_FORM: RateLimit;
	RL_CHANNEL_ACTIONS: RateLimit;
	RL_PUBLIC_ACTIONS: RateLimit;
	ASSETS: Fetcher;
	LIMITS_JSON: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIMITS_JSON" | "BETTER_AUTH_SECRET" | "IP_HASH_SECRET" | "ENCRYPTION_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY" | "DEV_LOGIN" | "APP_URL" | "ADMIN_EMAILS" | "EMAIL_FROM" | "TURNSTILE_SITE_KEY">> {}
}
